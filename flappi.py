...
anglictina = pygame.image.load('img/gb2.png')
...
def start_level1():
    global flying, game_over, score, pipe_frequency, ground_scroll, last_pipe, pass_pipe, pipe_gap
    flying = True
    game_over = False
    score = reset_game()
    pipe_frequency = 2500  
    ...
    text = napisfont.render("Etika", True, (255, 255, 255))
...
def start_level2():
    ...
    screen.fill((0, 0, 0))  
    napisfont = pygame.font.SysFont('mvboli', 140)
    text = napisfont.render("Slovencina", True, (255, 255, 255))
    text_rect = text.get_rect(center=(screen_width // 2.05, screen_height // 2))
    screen.blit(text, text_rect)
    pygame.display.update()
    pygame.time.delay(2000)  
